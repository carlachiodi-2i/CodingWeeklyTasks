document.addEventListener('DOMContentLoaded', () => {
  ...
  let nextRandom = 0
  let timerId
  const speed = [3000, 2500, 2000, 1500, 1000, 500, 200]
  ...
  // Add score
  function addScore() {
    // 24 rows of 12 "squares" -> 288 squares in total in the grid
    //Loop through each row and if the squares have "taken" class, add the score, clear the bottom line and add new line on top
    ...
    for (let levelNumber = 1; levelNumber <= 6; levelNumber++) {
      if (score >= levelNumber*100) {
